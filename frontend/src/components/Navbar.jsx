    ...
    return (
        <header>
            <button className="btn-menu" onClick={() => dispatch(toggleMenuState())}>
                <svg xmlns="http://www.w3.org/2000/svg" className="menu-icon" viewBox="0 0 512 512">
            ...
            {pageName === "home" ? (
                <HashLink className="logo-container" to="#headerTop">
                    <svg xmlns="http://www.w3.org/2000/svg" className="main-logo-icon" viewBox="0 0 512 512">
            ...
            <nav>
                <ul className="nav-items">
                    <li>
                        <Link className="nav-item" to="/" style={pageName === "home" ? selectionTab : {}}>
                            Үзвэр
                        </Link>
                    </li>
                    <li>
                        <Link className="nav-item" to="/showtimes" style={pageName === "showtimes" ? selectionTab : {}}>
                            Захиалга
                        </Link>
                    </li>
                    <li>
                        <Link className="nav-item" to="/aboutus" style={pageName === "aboutUs" ? selectionTab : {}}>
                            Танхим
                        </Link>
                    </li>
                    {isAuthenticated && signedPerson.person_type === "Admin" && (
                        <li>
                            <Link className="nav-item" to="/admin" style={pageName === "admin" ? selectionTab : {}}>
                                Admin
                            </Link>
                        </li>
                    )}
            ...
            <div className="nav-signup">
                {isAuthenticated && <p className="nav-signed-name">{signedPerson.first_name}</p>}
                <button
                    className="customer-profile-btn"
                    onClick={(e) => {
                        e.stopPropagation();
                        isAuthenticated && signedPerson.person_type === "Customer" ? navigate("/customer") : dispatch(showLoginModal());
                    }}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="profile-icon" viewBox="0 0 512 512">
                ...
                {!isAuthenticated ? (
                    <button className="btn-signup-arrow" onClick={toggleNavSignOptionsVis}>
                        {!navSignOptionsVis ? (
                            <svg xmlns="http://www.w3.org/2000/svg" className="signup-icon" viewBox="0 0 512 512">
                    ...
                    <button className="btn-logout" onClick={handlelogout}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="logout-icon" viewBox="0 0 512 512">

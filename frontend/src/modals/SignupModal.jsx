...
export const SignupModal = () => {
    ...
    const handleDataInsert = async (e) => {
        ...
        if (signupDetails.firstName !== "" && signupDetails.lastName !== "" && signupDetails.phoneNumber !== "" && signupDetails.phoneNumber.length === 8 && signupDetails.email !== "" && signupDetails.password !== "" && signupDetails.password.length >= 8) {
            try {
                setLoading(true);
        ...
        <div className="signup-form">
            <form onSubmit={(e) => handleDataInsert(e)}>
                <div className="signup-form-heading">
                    <h2 className="signup-form-heading-text">Аккоунт нээх</h2>
                ...
                <div className="signup-form-body">
                    <div className="signup-form-category-sp">
                        <div className="signup-form-category">
                            ...
                            <input name="lastName" type="text" value={signupDetails.lastName} placeholder="Овогоо оруулна уу" onChange={(e) => handleSignupDetails(e)} required />
                        </div>
                        <div className="signup-form-category">
                            <label>
                                Нэр: <span>*</span>
                            </label>
                            <input name="firstName" type="text" placeholder="Нэрээ оруулна уу" onChange={(e) => handleSignupDetails(e)} value={signupDetails.firstName} required />
                        </div>
                    </div>

                    <div className="signup-form-category">
                        <label>
                            Утасны дугаараа оруул(8 тоо байх ёстой): <span>*</span>
                        </label>
                        <input name="phoneNumber" type="number" value={signupDetails.phoneNumber} placeholder="Утасны дугаар." onChange={(e) => handleSignupDetails(e)} required />
                    </div>
                    ...
                    <div className="signup-form-category">
                        ...
                        <input name="email" type="email" value={signupDetails.email} placeholder="Имэйл хаяг" onChange={(e) => handleSignupDetails(e)} required />
                    </div>

                    <div className="signup-form-category">
                        <label>
                            Нууц үг(Хамгийн багадаа 8 оронтой байх ёстой): <span>*</span>
                        </label>
                        <div className="input-password">
                            <input name="password" value={signupDetails.password} type={passViewState ? "text" : "password"} onChange={(e) => handleSignupDetails(e)} placeholder="Нууц үгээ оруулна уу" required />
                    ...
                    <button type="submit" className="btn-reg" disabled={loading}>
                        {loading ? <BarLoader color="#e6e6e8" /> : "Бүртгүүлэх"}
                    </button>
                </div>
            </form>
        </div>

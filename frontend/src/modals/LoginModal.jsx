        ...
        <div className="login-form">
            <form
                ...
                <div className="signup-form-heading">
                    <h2 className="signup-form-heading-text">Нэвтрэх</h2>
                    <button type="button" className="btn-form-exit" onClick={() => dispatch(hideLoginModal())}>
                ...
                <div className="signup-form-body">
                    <div className="signup-form-category">
                        <label>
                            Имэйл хаягаа оруулна уу: <span>*</span>
                        </label>
                        <input name="email" type="email" value={loginDetails.email} placeholder="Имэйл хаяг" onChange={(e) => handleLoginDetails(e)} required />
                    </div>

                    <div className="signup-form-category">
                        <label>
                            Нууц үгээ оруулна уу: <span>*</span>
                        </label>
                        <div className="input-password">
                            <input name="password" value={loginDetails.password} type={passViewState ? "text" : "password"} placeholder="Нууц үг" onChange={(e) => handleLoginDetails(e)} required />
                    ...
                    <button type="submit" className="btn-reg" disabled={loading}>
                        {loading ? <BarLoader color="#e6e6e8" /> : "Нэвтрэх"}
                    </button>
                </div>
            </form>
        </div>

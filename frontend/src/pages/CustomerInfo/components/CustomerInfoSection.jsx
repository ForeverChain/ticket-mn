...
export const CustomerInfoSection = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post(`${import.meta.env.VITE_API_URL}/customerProfile`, {
            ...
            try {
                const response = await axios.post(`${import.meta.env.VITE_API_URL}/customerPurchases`, {
                    email: signedPerson.email,
                });
        ...
        return (
            <li key={id} className="purchase-history-item">
                ...
                <div className="purchase-item-img-box">
                    <img className="purchase-item-img" src={cusTicket.movie_image} alt="movie-photo" />
                </div>
            </li>
        );
    });
        ...
        <div className="section-customer-info">
            <div className="container">
                ...
                {loading1 ? (
                    ...
                    <div className="customer-info-details">
                        <div>
                            <p>Нэр</p>
                            <p>:</p>
                            <p>{cusProData && `${cusProData.first_name} ${cusProData.last_name}`}</p>
                        </div>
                ...
                {loading2 ? (
                    ...
                    <>
                        {cusTicketData.length === 0 && <p className="customer-empty-status">You haven&apos;t purchased any ticket yet</p>}
